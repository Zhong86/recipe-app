...
<section class="hero">
    ...
    <form action="{{ url('/my-recipes') }}" method="GET" class="search-bar">
        @if(request('category'))
...
<div class="category-strip">
    <div class="category-inner">
        ...
        @foreach($cats as $slug => $cat)
            <a
                href="{{ url('/my-recipes') }}?category={{ $slug === 'all' ? '' : $slug }}"
...
<div class="page">
    ...
    <div class="section-head">
        ...
        <a href="{{ url('/my-recipes') }}">View all →</a>
    </div>
    ...
    <div class="featured-grid">
        ...
        <a href="{{ url('/recipes/'.$f->id) }}" class="card-featured">
            ...
            @else
                <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=900&q=80" alt="{{ $f->title }}" loading="lazy">
            @endif
        ...
        <a href="{{ url('/recipes/'.$sf->id) }}" class="card-side">
            ...
            @else
                <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=80" alt="{{ $sf->title }}" loading="lazy">
            @endif
        ...
        <div class="recipe-grid">
            ...
            <a href="{{ url('/recipe/'.$recipe->id) }}" class="recipe-card">
                <div class="recipe-card-img">
                    ...
                    @auth
                    <button class="recipe-card-fav" title="Save to favourites" onclick="event.preventDefault()">♡</button>
                    @endauth
                </div>
